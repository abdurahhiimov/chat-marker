...
Copyright (c) 2026 Aziz Abdurahimov. Лицензия MIT (см. [LICENSE](LICENSE)) — можно использовать, копировать, менять и распространять, в том числе в коммерческих целях, если в копиях остаётся текст лицензии.

То, что репозиторий публичный и под MIT, не значит, что у кода нет автора. Код всё равно защищён авторским правом; лицензия — это разрешение всем его использовать, а не отказ от авторства. История коммитов в этом репозитории (под этим аккаунтом на GitHub, с таймстампами от самого первого коммита) — это запись о том, кто и когда это написал, как и у любого другого проекта.

Если делаете что-то на основе этого кода, ссылка или упоминание — это приятно, но по MIT не обязательно: лицензия требует только сохранять текст copyright-уведомления в копиях самого кода.

Этот раздел — общая информация, не юридическая консультация, я не юрист. Если дело дойдёт до реального спора вокруг этого кода, нужен юрист по интеллектуальной собственности в вашей юрисдикции, а не README.
